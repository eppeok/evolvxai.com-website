...
// Narrowed to a literal tuple (not GlobalSlug[]) so TypeScript keeps `global`
// scoped to these two below — Site Settings has no navItems field and must
// never be wiped by a content reseed.
const globals: ('footer' | 'header')[] = ['header', 'footer']
